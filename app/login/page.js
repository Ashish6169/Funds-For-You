...
const Login = () => {
    ...
    return (
        <div className='bg-lime-300 my-5' >
            <h1 className='text-center font-bold text-5xl p-2 text-black '> Login in To  Get Started </h1>

            <div className="social-login-buttons ">

                <div className="flex flex-col  items-center  ngap-2 min-h-screen bg-gray-100 p-10">


                    <button
                        className="flex items-center  w-64 my-2  border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
